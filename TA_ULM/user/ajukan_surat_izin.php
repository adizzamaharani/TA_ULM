...
<head>
    ...
    <title>Pengajuan Surat Izin Tidak Masuk Kuliah - Sistem Surat ULM</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header card-header-custom">
            Formulir Pengajuan Surat Izin Tidak Masuk Kuliah
        </div>
        <div class="card-body">
            <form action="proses_ajukan.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="jenis_surat" value="Surat Izin Tidak Masuk Kuliah">
                ...
                <div class="mb-3">
                    <label for="keperluan" class="form-label">Alasan Izin</label>
                    <textarea class="form-control" id="keperluan" name="keperluan" rows="3" required placeholder="Contoh: Izin karena ada acara keluarga di luar kota."></textarea>
                </div>
                <div class="row">
                ...
                <div class="alert alert-info">Jika diperlukan, silakan serahkan bukti pendukung (seperti surat dokter atau undangan) langsung ke bagian akademik.</div>
