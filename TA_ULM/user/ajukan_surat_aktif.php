...
<head>
    ...
    <title>Pengajuan Surat Mahasiswa Aktif - Sistem Surat ULM</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header card-header-custom">
            Formulir Pengajuan Surat Mahasiswa Aktif
        </div>
        <div class="card-body">
            <form action="proses_ajukan.php" method="POST">
                <!-- Hidden input untuk jenis surat -->
                <input type="hidden" name="jenis_surat" value="Surat Mahasiswa Aktif">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="keperluan" name="keperluan" rows="3" required placeholder="Contoh: Untuk mendaftar beasiswa KSE tahun 2024"></textarea>
                </div>
